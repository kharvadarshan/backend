...
export default function DoctorSlotScheduler({doctor}) {
  ...
  const addTimeSlot = async () => {
    setError("");
    const { date , startTime, endTime } = slots;
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 font-sans text-gray-800">
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl p-6 mb-8 text-white shadow-lg text-center">
      ...
      <div className="bg-white rounded-xl max-h-96  scroll-smooth overflow-y-auto p-6 border border-gray-500 shadow-sm">
        ...
        {timeSlots?.length === 0 ? (
          ...
          <ul className="divide-y divide-gray-100">
            {timeSlots?.reverse().map((timeSlot, index) => (

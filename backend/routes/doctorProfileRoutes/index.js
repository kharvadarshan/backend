...
const {isDoctorOrUser} = require('../../middlewares/userOrDoctorMiddleware');
...
router.get('/getDoctorById/:id',isDoctorOrUser,getDoctor);
...
router.post('/editProfile',isDoctor,upload.single('image'),editProfile);
